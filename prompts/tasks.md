...
| P40-T11 | `scripts/start_cloud_e2e.sh`, `supabase/seed.sql` | **Local E2E Testing Pipeline (No Mocks):** Script to spin up local Supabase, seed test users/keys/credits, dynamically configure Worker `.dev.vars`, and start `wrangler dev` for true E2E testing. | ⏳ Submitted | Jules |