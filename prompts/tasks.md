...
| P43-T5 | `wails-app/backend/stt_test.go` | **Go Backend Unit Tests:** Write comprehensive unit tests for the Speech-to-Text (`stt.go`) implementation and `app.go` bindings. | ⬜ | — |
