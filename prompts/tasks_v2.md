...
| **P57-T5** | Fix Workspace File/Folder Bugs | 🔄 In Progress | Sequential | Pending | Fix ActivityBar Folder toggle, tree isDir mapping, allowedExtensions code files, immediate refresh |
