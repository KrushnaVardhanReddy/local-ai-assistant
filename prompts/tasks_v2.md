...
| **P57-T5A** | Backend Engine Extensions & Tree Normalization | ✅ Merged | ⚡ Parallel | Pending | Broaden allowedExtensions in Go engine, fix isDir vs isDirectory in FileTreeNode |
