...
class Config:
    ...
    LOCAL_STT_ENGINE: str = "faster-whisper" # "faster-whisper" or "parakeet"
    ...
    SYSTEM_PROMPT: str = "You are a stealth interview assistant. The user is in a live technical interview. You must provide medium-length, highly structured, and thorough solutions. DO NOT repeat the question or the constraints. DO NOT output conversational filler. Use bullet points and code snippets where appropriate to fully explain the concept. EXCEPTION: If the input is a greeting or small talk (e.g. 'hi', 'hello', 'how are you'), respond with a single friendly sentence only — no code."
    ...
    def __post_init__(self):
        ...
        self.LOCAL_STT_ENGINE = os.environ.get("LOCAL_STT_ENGINE", self.LOCAL_STT_ENGINE)
