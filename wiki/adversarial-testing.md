...
- **The Integrity Platform**: Uses a Layer 2 Native Go Agent to enumerate OS windows and detect the presence of capture-exclusion flags, even if it cannot see the window contents.
